...
try {
    ...
    $mail->addStringAttachment($pdfOutput, 'rutina de ejercicios nro '.$rut_cod.'pdf', 'base64', 'application/pdf');

    // Contenido del correo
    $mail->isHTML(true);
    $mail->Subject = 'Rutina de ejercicios Nro. '.$rut_cod; //asunto del correo
    $mail->Body = '<html lang="es">
                    ...
                    <body>
                        ...
                        <p>
                            Por medio de la presente, se adjunta a este correo su rutina de ejercicios semanales acorde al
                            tipo de entrenamiento solicitado por usted. En el documento encontrará un desglose detallado
                            de las series y repeticiones que debe realizar, así como los equipos a ser utilizados.
                        </p>
