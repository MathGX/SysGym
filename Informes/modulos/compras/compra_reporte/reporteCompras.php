    ...
    <?php foreach ($datos as $cabecera) { ?>
        <table class="grilla">
            ...
            <tbody>
                ...
                <?php 
                    $sql2 = "select * from v_compra_det
                            where com_cod = {$cabecera['com_cod']};";
                ...
                foreach ($datos2 as $detalle) { 
                    if ($detalle['tipitem_cod'] == 1) {
                        $impuesto10 = $detalle['comdet_precio'];
                    } else {
                    ...
                    <tr class = "cuerpo">
                        ...
                        <td>
                            <?php echo $detalle['comdet_cantidad']; ?>
                        </td>
                        <td>
                            <?php echo $detalle['comdet_precio']; ?>
                        </td>
                        <td>
                    ...
                    <tr id = "total">
                        <td colspan='7' style='font-weight: bold;'>TOTAL A PAGAR: </td>
                    ...
                    <tr id = "impuesto">
                        ...
                        <td colspan='3' style='font-weight: bold;'>TOTAL IVA: <?php echo $totalIva_format?> </td>
                    </tr>
            </tbody>
        </table>
    <?php } ?>
