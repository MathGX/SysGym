...
$sql = "select * from v_nota_compra_cab
        where notacom_fecha between '$desde' and '$hasta';";
    ...
    <?php foreach ($datos as $cabecera) { ?>
        <table class="grilla">
            <thead class="cabecera">
                <tr>
                    <th>NRO.: <?php echo $cabecera['notacom_cod']; ?></th>
                    <th>FECHA: <?php echo $cabecera['notacom_fecha']; ?></th>
                    <th>USUARIO: <?php echo $cabecera['usu_login'] ?></th>
                    <th>SUCURSAL: <?php echo $cabecera['suc_descri'] ?></th>
                    <th colspan="2">COMPRA NRO.: <?php echo $cabecera['com_cod'] ?></th>
                </tr>
                <tr>
                    <th>FACTURA: <?php echo $cabecera['com_nrofac']; ?></th>
                    <th>NOTA: <?php echo $cabecera['tipcomp_descri']; ?></th>
                    <th>NOTA NRO.: <?php echo $cabecera['notacom_nronota']; ?></th>
                    <th>CONCEPTO: <?php echo $cabecera['notacom_concepto']; ?></th>
                    <th>ESTADO: <?php echo $cabecera['notacom_estado'] ?></th>
                </tr>
            </thead>
            <tbody>
                <tr class="detalle">
                ...
                <?php 
                    $sql2 = "select * from v_nota_compra_det
                            where notacom_cod = {$cabecera['notacom_cod']};";
                ...
                foreach ($datos2 as $detalle) { 
                    if ($detalle['tipitem_cod'] == 1) {
                        $impuesto10 = $detalle['notacomdet_precio'];
                    } else {
                    ...
                    <tr class = "cuerpo">
                        ...
                        <td>
                            <?php echo $detalle['notacomdet_cantidad']; ?>
                        </td>
                        <td>
                            <?php echo $detalle['notacomdet_precio']; ?>
                        </td>
                        <td>
                    ...
                    <tr id = "impuesto">
                        <td colspan='2' style='font-weight: bold;'>IVA 5%: <?php echo $discrIva5_format?> </td>
                        <td colspan='2' style='font-weight: bold;'>IVA 10%: <?php echo $discrIva10_format?> </td>
