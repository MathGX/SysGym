...
<head>
    ...
    <title>Reporte forma de cobro</title>
</head>
<?php
...
$sql = "select * from forma_cobro 
        where forcob_cod between $desde and $hasta
        order by forcob_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['forcob_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['forcob_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['forcob_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_forma_cobro.pdf', array("Attachment" => false));
?>