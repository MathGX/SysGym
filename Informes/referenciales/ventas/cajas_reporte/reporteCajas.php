...
$sql = "select 
        ...
        e.emp_razonsocial
        from caja c 
        join sucursales s on s.suc_cod = c.suc_cod and s.emp_cod = c.emp_cod 
            join empresa e on e.emp_cod = s.emp_cod
        where c.caj_cod between $desde and $hasta
        order by c.caj_cod;";
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    ...
                    <td>
                        <?php echo $fila['caj_descri'] ?>
                    </td>
                    <td>
                        <?php echo $fila['caj_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
