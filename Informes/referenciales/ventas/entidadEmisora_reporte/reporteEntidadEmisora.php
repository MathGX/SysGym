...
<head>
    ...
    <title>Reporte entidades financieras</title>
</head>
<?php
...
$sql = "select * from entidad_emisora 
        where ent_cod between $desde and $hasta
        order by ent_cod;";
...
$dompdf->stream('reporte_entidad_emisora.pdf', array("Attachment" => false));
?>