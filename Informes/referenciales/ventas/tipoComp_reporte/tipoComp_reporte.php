...
<head>
    ...
    <title>Reporte tipo de comprobante</title>
</head>
<?php
...
$sql = "select * from tipo_comprobante 
        where tipcomp_cod between $desde and $hasta
        order by tipcomp_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['tipcomp_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipcomp_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipcomp_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_tipo_comprobante.pdf', array("Attachment" => false));
?>