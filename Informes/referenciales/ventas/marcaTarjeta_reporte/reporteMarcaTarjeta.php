...
<head>
    ...
    <title>Reporte marca de tarjeta</title>
</head>
<?php
...
$sql = "select * from marca_tarjeta 
        where martarj_cod between $desde and $hasta
        order by martarj_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['martarj_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['martarj_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['martarj_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
