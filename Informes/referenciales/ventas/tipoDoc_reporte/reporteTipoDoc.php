...
$sql = "select * from tipo_documento 
        where tipdoc_cod between $desde and $hasta
        order by tipdoc_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['tipdoc_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipdoc_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipdoc_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_tipo_documento.pdf', array("Attachment" => false));
?>