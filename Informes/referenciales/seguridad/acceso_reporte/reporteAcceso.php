...
$sql = "select * from acceso 
        where acc_fecha between '$desde' and '$hasta'
        order by acc_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['acc_usu']; ?>
                    </td>
                    <td>
                        <?php echo $fila['acc_fecha']; ?>
                    </td>
                    <td>
                        <?php echo $fila['acc_hora'] ?>
                    </td>
                    <td>
                        <?php echo $fila['acc_obs'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_accesos.pdf', array("Attachment" => false));
?>