...
<head>
    ...
    <title>Reporte GUI por Perfil</title>
</head>
<?php
...
$sql = "select *
        ...
        where gp.guiperf_cod between $desde and $hasta
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['guiperf_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['perf_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['gui_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['mod_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['guiperf_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_permisos.pdf', array("Attachment" => false));
?>