...
$sql = "select 
        ...
        where g.gui_cod between $desde and $hasta
        order by gui_cod;";
...
$dompdf->stream('reporte_gui.pdf', array("Attachment" => false));
?>