...
<head>
    ...
    <title>Reporte perfil por permisos</title>
</head>
<?php
...
$sql = "select * from perfiles_permisos pp
...
$dompdf->stream('reporte_perfiles_permisos.pdf', array("Attachment" => false));
?>