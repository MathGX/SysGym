        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    ...
                    <td>
                        <?php echo $fila['suc_telefono'] ?>
                    </td>
                    <td>
                        <?php echo $fila['suc_direccion'] ?>
                    </td>
                    <td>
                        <?php echo $fila['ciu_descripcion'] ?>
                    </td>
                    <td>
                        <?php echo $fila['suc_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_sucursales.pdf', array("Attachment" => false));
?>