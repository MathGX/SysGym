...
$sql = "select 
        ...
        where e.equi_cod between $desde and $hasta
        order by e.equi_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['equi_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['equi_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipequi_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['equi_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_equipos.pdf', array("Attachment" => false));
?>