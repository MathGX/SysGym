...
<head>
    ...
    <title>Reporte horarios de comida</title>
</head>
<?php
...
$sql = "select * from horarios_comida 
        where hrcom_cod between $desde and $hasta
        order by hrcom_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['hrcom_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['hrcom_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['hrcom_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_horarios_comida.pdf', array("Attachment" => false));
?>