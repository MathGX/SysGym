...
$sql = "select 
        ...
        where p.per_cod between $desde and $hasta
        order by p.per_cod;";
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    ...
                    <td>
                        <?php echo $fila['per_telefono'] ?>
                    </td>
                    <td>
                        <?php echo $fila['per_email'] ?>
                    </td>
                    <td>
                        <?php echo $fila['tipdoc_descri'] ?>
                    </td>
                    <td>
                        <?php echo $fila['per_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_personas.pdf', array("Attachment" => false));
?>