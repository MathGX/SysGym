...
$sql = "select * from dias 
        where dia_cod between $desde and $hasta
        order by dia_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['dia_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['dia_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['dia_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_dias.pdf', array("Attachment" => false));
?>