...
<head>
    ...
    <title>Reporte parametros de medicion</title>
</head>
<?php
...
$sql = "select * from parametros_medicion 
        where param_cod between $desde and $hasta
        order by param_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['param_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['param_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['param_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_param_medi.pdf', array("Attachment" => false));
?>