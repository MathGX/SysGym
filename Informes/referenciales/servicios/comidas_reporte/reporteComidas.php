...
$sql = "select * from comidas 
        where comi_cod between $desde and $hasta
        order by comi_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['comi_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['comi_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['comi_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
    ...
    <div class="usuario">
        <table class ="grilla2">
            <tbody>
                ...
                <td class="grilla2">
                    <div class="item">
                        <span class="label">EMIIDO POR:</span>
                        <span class="valor">
                            <?php echo $usuario; ?>
                            </span>
                        </div>
...
$dompdf->stream('reporte_comidas.pdf', array("Attachment" => false));
?>