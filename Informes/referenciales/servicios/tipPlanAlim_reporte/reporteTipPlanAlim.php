...
<head>
    ...
    <title>Reporte tipos de plan alimenticio</title>
</head>
<?php
...
$sql = "select * from tipo_plan_alimenticio 
        where tiplan_cod between $desde and $hasta
        order by tiplan_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['tiplan_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tiplan_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tiplan_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_tipo_plan_alimenticio.pdf', array("Attachment" => false));
?>