...
<head>
    ...
    <title>Reporte ejercicios</title>
</head>
<?php
...
$sql = "select * from ejercicios 
        where ejer_cod between $desde and $hasta
        order by ejer_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['ejer_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['ejer_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['ejer_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_ejercicios.pdf', array("Attachment" => false));
?>