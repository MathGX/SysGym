...
<head>
    ...
    <title>Reporte tipos de rutina</title>
</head>
<?php
...
$sql = "select * from tipo_rutinas 
        where tiprut_cod between $desde and $hasta
        order by tiprut_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['tiprut_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tiprut_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tiprut_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_tipo_rutinas.pdf', array("Attachment" => false));
?>