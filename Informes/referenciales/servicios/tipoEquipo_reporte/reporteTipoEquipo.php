...
$sql = "select * from tipo_equipos 
        where tipequi_cod between $desde and $hasta
        order by tipequi_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['tipequi_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipequi_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['tipequi_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_tipos_equipo.pdf', array("Attachment" => false));
?>