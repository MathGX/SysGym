...
$sql = "select * from unidad_medida 
        where uni_cod between $desde and $hasta
        order by uni_cod;";
    ...
    <table class="grilla">
        ...
        <tbody>
            <?php foreach ($datos as $fila) { ?>
                <tr>
                    <td>
                        <?php echo $fila['uni_cod']; ?>
                    </td>
                    <td>
                        <?php echo $fila['uni_descri']; ?>
                    </td>
                    <td>
                        <?php echo $fila['uni_estado'] ?>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
...
$dompdf->stream('reporte_unidad_medida.pdf', array("Attachment" => false));
?>