    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-lg-12 tblcab">
                    <!-- formulario de RECLAMOS cabecera -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE RECLAMOS <small>Registro de los reclamos del cliente</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <!-- botones del formulario de reclamos -->
                ...
                <div class="col-lg-12 tbl">
                    <!-- grilla del formulario RECLAMOS-->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                            RECLAMOS REGISTRADAS <small>Listado de reclamos</small>
                            </h2>
                        </div>
                        <div class="body">
