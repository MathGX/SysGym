...
let controlVacio = () => {
    ...
    if ($("#med_cod").val() == "") {
        ...
        condicion = "i";
    } else if ($("#med_fecha").val() == "") {
        condicion = "i";
    } else if ($("#cliente").val() == "") {
        condicion = "i";
    } else if ($("#ins_cod").val() == "") {
        condicion = "i";
    } else if ($("#med_estado").val() == "") {
        condicion = "i";
    }
...
let agregar = () => {
    $("#operacion_det").val(1);
    $("#param_cod, #param_descri, #meddet_cantidad, #uni_descri, #param_formula").val('');
    $(".disabledno").removeAttr("disabled");
...
function grabar2() {
    $.ajax({
        ...
        data: {
            ...
            meddet_cantidad: $("#meddet_cantidad").val(),   
