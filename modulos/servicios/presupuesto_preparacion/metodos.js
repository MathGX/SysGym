...
let limpiarCab = () =>{
    ...
    $(".tblcab .body #prpr_fecha").each(function(){
        ...
        for (objeto of respuesta) {
            ...
            totalI10 += parseFloat (objeto.iva10);
                tabla += "<tr onclick='seleccionarFila2(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    ...
                    tabla += "<td style='text-align:right;'>" + objeto.prprdet_cantidad + "</td>";
                    tabla += "<td style='text-align:right;'>" + new Intl.NumberFormat('us-US').format(objeto.prprdet_precio) + "</td>";
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    ...
                    tabla += "<td>" + objeto.prpr_fechavenci2 + "</td>";
                    tabla += "<td>" + objeto.prpr_estado + "</td>";
                tabla += "</tr>";
            }
