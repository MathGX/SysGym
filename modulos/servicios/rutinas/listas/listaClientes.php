...
where ppc.prpr_estado = 'APROBADO'
	...
	and ppd.itm_cod in (5,7) and ppd.tipitem_cod = 1
...
if (empty($datos)) {
        echo json_encode(
                array(
                        "fila" => "La persona no se encuentra inscripta, el presupuesto no fue aprobado o no compró uno de los servicios de ENTRENAMIENTO",
                        "true" => true
                )
        );
