...
function grabar2() {
    $.ajax({
        ...
        data: {
            rut_cod: $("#rut_cod").val().trim(),
            ejer_cod: $("#ejer_cod").val().trim(),
            rutdet_series: $("#rutdet_series").val().trim(),
            rutdet_repeticiones: $("#rutdet_repeticiones").val().trim(),
            dia_cod: $("#dia_cod").val().trim(),           
            equi_cod: $("#equi_cod").val().trim(),
            tipequi_cod: $("#tipequi_cod").val().trim(),           
