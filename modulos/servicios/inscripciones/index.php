    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-lg-12 tblcab">
                    <!-- formulario de INSCRIPCIONES cabecera -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE INSCRIPCIONES<small>Registro de inscripciones de clientes</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="ins_cod" class="form-control" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                        <input type="hidden" id="per_telefono" value="0">
                ...
                <div class="col-lg-12 tbl">
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                INSCRIPCIONES REGISTRADAS <small>Listado de inscripciones</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
