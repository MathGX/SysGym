...
if (isset($_POST['operacion_cab'])) {
    ...
    $evo_estado = pg_escape_string($conexion, $_POST['evo_estado']);
    ...
    if (strpos($error, "1") !== false) {
        $response = array(
            "mensaje" => "ESTE CLIENTE YA CUENTA CON UN REGISTRO DE EVOLUCION",
            "tipo" => "error"
        );
    } else {
        $response = array(
    ...
    $evoCod = "select coalesce (max(evo_cod),0)+1 as codigo from evolucion_cab;";
    ...
    $sql = "select * from v_evolucion_cab;";
