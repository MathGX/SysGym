...
let grabar = () => {
    $.ajax({
        ...
        url: "controlador.php",
        data: {
            evo_cod: $("#evo_cod").val().trim(),
            evo_fecha: $("#evo_fecha").val().trim(),
            evo_estado: $("#evo_estado").val().trim(),
...
function grabar2() {
    $.ajax({
        ...
        data: {
            ...
            evodet_registro_ant: $("#evodet_registro_ant").val().trim(),
            evodet_registro_act: $("#evodet_registro_act").val().trim(),
            evodet_fecha: $("#evodet_fecha").val().trim(),
        ...
        data: {
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila2(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>" + objeto.evodet_fecha2 + "</td>";
...
function getParametro() {
    $.ajax({
        ...
        data: {
            param_descri:$("#param_descri").val().trim(),
            med_cod:$("#med_cod").val().trim(),
            evo_cod:$("#evo_cod").val().trim(),
        }
