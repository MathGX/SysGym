...
$sql = "select 
        ...
        i.tipimp_cod,
        i.itm_descri,
        ocd.ordcomdet_cantidad as comdet_cantidad,
        um.uni_descri||' ('||um.uni_simbolo||')' as uni_descri,
        ocd.ordcomdet_precio as comdet_precio
        ...
        where ocd.ordcom_cod = $orden and i.itm_descri ilike '%$item%'
