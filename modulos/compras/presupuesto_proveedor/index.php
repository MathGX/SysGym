...
<head>
    ...
    <title>PRESUPUESTO DEL PROVEEDOR</title>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-lg-12 tblcab">
                    <!-- formulario de presupuesto proveedor cabecera -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE PRESUPESTOS DE PROVEEDORES<small>Registro de presupuestos enviados por el proveedor</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="presprov_cod" class="form-control" disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus focused">
                                            <input type="date" id="presprov_fechavenci" class="form-control disabledno" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="presprov_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbldet" style="display: none;">
                    <div class="card">
                    <!-- formulario de detalles de presupuesto proveedor -->
                        <div class="header bg-indigo">
                            <h2>
                        ...
                        <!-- grilla del detalle de presupuestos -->
