            ...
            <div class="col-lg-12 tblcab">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE NOTAS DE COMPRAS<small>Registro de notas de compras recibidas</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus focused">
                                            <input type="text" id="notacom_fecha" class="form-control disabledno" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="notacom_concepto" class="form-control" disabled >
                                            <label class="form-label">Concepto</label>
                                            <div id="listaConcepto" style="display: none;">
                                                <ul class="list-group" id="ulConcepto" style="height:60px; overflow:scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" class="form-control disabledno" id="pro_razonsocial" disabled onkeyup="getCompra()">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" class="form-control" id="com_nrofac" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="notacom_nronota" class="form-control disabledno" disabled>
                                            <label class="form-label">Nota Nro.</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line foc">
                                            <input type="number" id="notacomdet_cantidad" class="form-control disabledno" disabled onkeyup="cantItem()" onchange="cantItem()">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line foc">
                                            <input type="number" id="notacomdet_precio" class="form-control disabledno" disabled>
