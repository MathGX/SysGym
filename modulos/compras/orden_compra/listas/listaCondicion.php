...
$ordcom_condicionpago = [
        array('ordcom_condicionpago' => "CONTADO"), 
        array('ordcom_condicionpago' => "CREDITO")
];

// Obtener el valor enviado por POST
$condi_pago = $_POST['ordcom_condicionpago'];

// Inicializar una variable para almacenar las coincidencias
$resultados = [];

// buscar coincidencias
foreach ($ordcom_condicionpago as $condicion) {
        if (stripos($condicion['ordcom_condicionpago'], $condi_pago) !== false) { // Comparar sin distinguir mayúsculas/minúsculas
