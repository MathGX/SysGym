                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <div id="listaNota" style="display: none;">
                                                <ul class="list-group" id="ulNota" style="height: 60px; width: 250px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="notven_concepto" class="form-control" disabled>
                                            <label class="form-label">Concepto</label>
                                            <div id="listaConcepto" style="display: none;">
                                                <ul class="list-group" id="ulConcepto" style="height: 60px; width: 250px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <div id="listaVentas" style="display: none;">
                                                <ul class="list-group" id="ulVentas" style="height: 60px; width: 350px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line foc">
                                            ...
                                            <div id="listaItems" style="display: none;">
                                                <ul class="list-group" id="ulItems" style="height: 60px; width: 250px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3" style="display: none">
                                    <div class="form-group form-float">
                                        <div class="form-line foc">
                                            ...
                                            <input type="text" class="form-control disabledno2" id="tipitem_descri" disabled>
