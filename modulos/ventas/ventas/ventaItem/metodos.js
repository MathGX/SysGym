...
let controlVacio2 = () => {
    ...
    if (condicion === "i") {
        ...
        if (($("#tipitem_cod").val() == "1") && $("#vendet_cantidad").val() !== "0") {
            swal({
                title: "RESPUESTA!!",
        ...
        data: {
            ...
            for (objeto of respuesta) {
                if (objeto.tipitem_cod == 1){
                    impuesto10 = parseFloat (objeto.vendet_precio);
                } else {
...
function getDeposito() {
    $.ajax({
        method: "POST",
        url: "/SysGym/modulos/ventas/ventas/ventaItem/listas/listaDeposito.php",
        data: {
...
//capturamos los datos de la tabla pedido_venta_cab en un JSON a través de POST para listarlo
function getPedido() {
    $.ajax({
        method: "POST",
