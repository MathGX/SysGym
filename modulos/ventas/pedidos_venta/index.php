...
<body class="theme">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                    <!-- formulario de pedido VENTAS cabecera -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE PEDIDOS DE VENTAS<small>Registro de pedidos a recibidos</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <!-- botones del formulario de pedidos de venta -->
                            </div>
                            <div class="icon-and-text-button-demo">
                                ...
                                <?php } ?>
                                <?php if($u['mod_descri'] == 'VENTAS') {?>
                                    <button type="button" style="width:12.5%;" class="btn bg-light-blue waves-effect btnOperacion1" onclick="persona()">
                                        <i class="material-icons">person</i>
                                        <span>AGG PERSONA</span>
                                    </button>
                                <?php } ?>
                                <?php if($u['mod_descri'] == 'VENTAS') {?>
                                    <button type="button" style="width:12.5%;" class="btn bg-light-blue waves-effect btnOperacion1" onclick="cliente()">
                                        <i class="material-icons">person</i>
                ...
                <div class="col-lg-12 tbldet" style="display: none;">
                    <div class="card">
                    <!-- formulario de detalles de pedidos de venta -->
                        <div class="header bg-indigo">
                            <h2>
                                DETALLE DEL PEDIDO
                            </h2>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line foc">
                                            <input type="text" id="pedvendet_precio" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                PEDIDOS REGISTRADOS <small>Listado de pedidos de ventas realizados</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
