...
<body class="theme">
    ...
    $sql = "select count(*) as cantidad from funcionarios;";
    $resultado = pg_query($conexion, $sql);
    $funcionarios = pg_fetch_assoc($resultado);

    $sql2 = "select count(*) as cantidad from clientes;";
    $resultado2 = pg_query($conexion, $sql2);
    $clientes = pg_fetch_assoc($resultado2);

    $sql3 = "select count(*) as cantidad from acceso where acc_obs = 'ACCESO CORRECTO';";
    $resultado2 = pg_query($conexion, $sql3);
    $access = pg_fetch_assoc($resultado2);
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <span> <?php echo $funcionarios['cantidad']?> </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <span> <?php echo $clientes['cantidad']?> </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">CANT. ACCESOS</div>
                            <span> <?php echo $access['cantidad']?> </span>
                        </div>
                    </div>
                </div>
            </div>
