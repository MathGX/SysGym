    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de ENTIDAD ADHERIDA-->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE ENTIDAD ADHERIDA<small>Registrar entidades adheridas</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2" style="display: none">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="entahd_cod" class="form-control" value="0" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="entahd_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de ENTIDAD ADHERIDA -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario ENTIDAD ADHERIDA -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE ENTIDADES ADHERIDAS<small>Lista de marcas de tarjeta emitidas por cada entidad</small>
                            </h2>
                        </div>
                        <div class="body">
