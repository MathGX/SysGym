...
let getCod = () => {
    $.ajax({
        ...
        $("#tipcli_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        url: "controlador.php",
        data: {
            tipcli_cod: $("#tipcli_cod").val(),
            tipcli_descri: $("#tipcli_descri").val(),
            tipcli_estado: $("#tipcli_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>"+ objeto.tipcli_cod +"</td>";
                    tabla += "<td>"+ objeto.tipcli_descri +"</td>";
                    tabla += "<td>"+ objeto.tipcli_estado +"</td>";
                tabla += "</tr>";
            }
