...
let getCod = () => {
    $.ajax({
        ...
        $("#tipdoc_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tipdoc_estado: $("#tipdoc_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>";
                        tabla += objeto.tipdoc_cod;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipdoc_descri;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipdoc_estado;
                    tabla += "</td>";
                tabla += "</tr>";
            }
