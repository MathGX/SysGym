    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de marcas de tarjeta cobro -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE MARCAS DE TARJETA<small>Registrar marcas</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="martarj_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="martarj_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de marcas de tarjeta -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario marcas de tarjeta -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE MARCAS DE TARJETA<small>marcas de tarjeta admitidas</small>
                            </h2>
                        </div>
                        <div class="body">
