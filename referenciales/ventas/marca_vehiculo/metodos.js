...
let getCod = () => {
    $.ajax({
        ...
        $("#marcve_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            marcve_estado: $("#marcve_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>"+ objeto.marcve_cod +"</td>";
                    tabla += "<td>"+ objeto.marcve_descri +"</td>";
                    tabla += "<td>"+ objeto.marcve_estado +"</td>";
                tabla += "</tr>";
            }
