    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de MODELOS DE VEHICULOS -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE MODELOS DE VEHICULOS<small>Registrar los de modelos de vehiculos</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="modve_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" class="form-control disabledno soloTxt" id="marcve_descri" disabled onkeyup="getMarca()">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="modve_descri" class="form-control disabledno sinCarac" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="modve_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE MODELOS DE VEHICULOS<small>modelos de vehiculos vigentes</small>
                            </h2>
                        </div>
                        <div class="body">
