    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                            CLIENTES<small>Registrar los datos de clientes</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="cli_cod" class="form-control" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="cli_direccion" class="form-control disabledno" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="cli_estado" class="form-control" disabled>
                ...
                <!-- grilla del formulario clientes-->
                <div class="col-lg-12 tbl" style="display: block;">
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO CLIENTES<small>Clientes registrados</small>
                            </h2>
                        </div>
                        <div class="body">
