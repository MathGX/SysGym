...
let getCod = () => {
    $.ajax({
        ...
        $("#tipcomp_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tipcomp_estado: $("#tipcomp_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>";
                        tabla += objeto.tipcomp_cod;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipcomp_descri;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipcomp_estado;
                    tabla += "</td>";
                tabla += "</tr>";
            }
