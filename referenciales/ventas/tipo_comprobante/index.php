        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE TIPOS DE COMPROBANTE<small>Registrar los de tipos de comprobantes</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tipcomp_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tipcomp_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tipcomp_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de tipo de comprobantes -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario tipo COMPROBANTE -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE TIPOS DE COMPROBANTE<small>Tipos de comprobantes utilizados</small>
                            </h2>
                        </div>
                        <div class="body">
