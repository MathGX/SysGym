        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE CAJA<small>Registrar datos de cajas de la empresa</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="caj_cod" class="form-control" disabled>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <div id="listaEmpresaSuc" style="display: none;">
                                                <ul class="list-group" id="ulEmpresaSuc" style="height: 60px; width: 250px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <div id="listaSucursalEmp" style="display: none;">
                                                <ul class="list-group" id="ulSucursalEmp" style="height: 60px; width: 250px; overflow: scroll;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="caj_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="caj_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de caja -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario caja -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE CAJA<small>Caja de cada sucursal</small>
                            </h2>
                        </div>
                        <div class="body">
