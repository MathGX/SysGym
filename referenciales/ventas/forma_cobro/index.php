    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de formas de cobro -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE FORMAS DE COBRO<small>Registrar las de formas de cobro</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="forcob_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="forcob_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="forcob_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de formas de cobro -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario formas de cobro -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE FORMAS DE COBRO<small>Formas de cobro admitidas</small>
                            </h2>
                        </div>
                        <div class="body">
