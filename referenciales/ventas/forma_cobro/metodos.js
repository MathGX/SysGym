...
let getCod = () => {
    $.ajax({
        ...
        $("#forcob_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            forcob_estado: $("#forcob_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>";
                        tabla += objeto.forcob_cod;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.forcob_descri;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.forcob_estado;
                    tabla += "</td>";
                tabla += "</tr>";
            }
