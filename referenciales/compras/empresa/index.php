        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE EMPRESAS<small>Registrar datos de empresas</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="emp_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="emp_email" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="emp_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario empresas -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE EMPRESAS <small>Empresas registradas</small>
                            </h2>
                        </div>
                        <div class="body">
