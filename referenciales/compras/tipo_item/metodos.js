...
let getCod = () => {
    $.ajax({
        ...
        $("#tipitem_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tipitem_estado: $("#tipitem_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>"+ objeto.tipitem_cod +"</td>";
                    tabla += "<td>"+ objeto.tipitem_descri +"</td>";
                    tabla += "<td>"+ objeto.tipitem_estado +"</td>";
                tabla += "</tr>";
            }
