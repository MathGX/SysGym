    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de TIPO PROVEEDOR -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE TIPOS DE PROVEEDOR<small>Registrar los de tipos de proveedor</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiprov_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiprov_descripcion" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiprov_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE TIPOS DE PROVEEDOR<small>Tipos de proveedor de insumos</small>
                            </h2>
                        </div>
                        <div class="body">
