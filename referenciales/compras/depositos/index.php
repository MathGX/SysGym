    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de depositos -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE DEPOSITOS<small>Registrar datos de depositos</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="dep_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="dep_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de depositos -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario depositos -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE DEPOSITOS<small>Depositos de cada sucursal</small>
                            </h2>
                        </div>
                        <div class="body">
