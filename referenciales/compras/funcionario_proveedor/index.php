...
<head>
    ...
    <title>FUNCIONARIOS DE LOS PROVEEDORES</title>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de funcionarios de los proveedores -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE FUNCIONARIOS DE LOS PROVEEDORES<small>Datos de los funcionarios de los proveedores con los que se trabajarán</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="funprov_cod" class="form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" id="pro_razonsocial" class="form-control disabledno sinCarac" disabled onkeyup="getProveedor()">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="funprov_nro_doc" class="form-control soloNum" disabled>
                                            <label class="form-label">Nro. Doc. (Opcional)</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="funprov_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de funcionarios de los proveedores -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario funcionarios de los proveedores -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE FUNCIONARIOS DE LOS PROVEEDORES <small>Funcionarios de los proveedores con los que la empresa trabaja</small>
                            </h2>
                        </div>
                        <div class="body">
