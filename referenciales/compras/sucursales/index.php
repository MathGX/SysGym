        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE SUCURSALES<small>Registrar datos de sucursales</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="suc_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="suc_direccion" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="suc_email" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="suc_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de sucursales -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario sucursales -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE SUCURSALES <small>sucursales registradas</small>
                            </h2>
                        </div>
                        <div class="body">
