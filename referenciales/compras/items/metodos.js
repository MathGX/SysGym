        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>"+ objeto.itm_cod +"</td>";
                    tabla += "<td>"+ objeto.tipitem_descri +"</td>";
                    tabla += "<td>"+ objeto.itm_descri +"</td>";
                    tabla += "<td>"+ objeto.uni_descri +"</td>";
                    tabla += "<td>"+  objeto.itm_costo +"</td>";
                    tabla += "<td>"+ objeto.itm_precio +"</td>";
                    tabla += "<td>"+  objeto.tipimp_descri +"</td>";
                    tabla += "<td>"+ objeto.itm_stock_min +"</td>";
                    tabla += "<td>"+ objeto.itm_stock_max +"</td>";
                    tabla += "<td>"+ objeto.itm_estado +"</td>";
                tabla += "</tr>";
            }
