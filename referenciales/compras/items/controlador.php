...
if (isset($_POST['operacion'])) {
    ...
    $itm_estado = pg_escape_string($conexion, $_POST['itm_estado']);
    $uni_descri = pg_escape_string($conexion, $_POST['uni_descri']);
    $tipitem_descri = pg_escape_string($conexion, $_POST['tipitem_descri']);
    $tipimp_descri = pg_escape_string($conexion, $_POST['tipimp_descri']);

    //reemplazar las comas por puntos para que lo tome como decimal
    $itm_precio = str_replace(',', '.', $_POST['itm_precio']);
