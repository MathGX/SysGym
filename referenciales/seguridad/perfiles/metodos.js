...
let listar = () => {
    $.ajax({
        ...
        for (objeto of respuesta) {
            ...
            tabla += "<td>";
            tabla += objeto.perf_cod;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.perf_descri;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.perf_estado;
            tabla += "</td>";
            tabla += "</tr>";
        }
