...
<head>
    ...
    <title>ASINACIÓN DE PERMISOS</title>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                            ASINACIÓN DE PERMISOS A USUARIOS<small>Asignar los permisos para cada usuario por su perfil</small>
                            </h2>
                        </div>
                        <div class="body">
                            <input type="hidden" id="operacion" value="0">
                            <input type="hidden" id="usu_cod_reg" value="<?php echo $u['usu_cod'];?>">
                            <input type="hidden" id="usu_login_reg" value="<?php echo $u['usu_login'];?>">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2" style="display:none">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="hidden" id="asigusu_cod" value="0" class="form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="hidden" id="usu_cod" value="0">
                                            <input type="text" class="form-control disabledno" id="usu_login" disabled onkeyup="getUsuarios()">
                                            <label class="form-label">Usuario</label>
                                            <div id="listaUsuarios" style="display: none;">
                                                <ul class="list-group" id="ulUsuarios" style="height:60px; overflow:auto;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                        <input type="hidden" id="perfperm_cod" value="0">
                                            <input type="hidden" id="perf_cod" value="0">
                                            <input type="text" class="form-control" id="perf_descri" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" class="form-control" id="permi_descri" disabled >
                                            <label class="form-label">Permiso</label>
                                            <div id="listaPermisosPerf" style="display: none;">
                                                <ul class="list-group" id="ulPermisosPerf" style="height:60px; overflow:auto;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="asigusu_estado" class="form-control" disabled>
                                ...
                                <!-- botones del formulario de asignacion -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario asignacion-->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO ASIGNACIÓN DE PERMISOS <small>Listado de los permisos asignados a los usuarios por perfil</small>
                            </h2>
                        </div>
                        <div class="body">
