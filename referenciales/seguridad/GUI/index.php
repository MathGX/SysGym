        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE GUI<small>Registrar datos de GUI</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="gui_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="gui_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="gui_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario gui -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE GUI <small>Interfaces gráficas de usuario</small>
                            </h2>
                        </div>
                        <div class="body">
