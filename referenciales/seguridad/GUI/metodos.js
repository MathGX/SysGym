...
let agregar = () => {
    ...
    $("#mod_descri, #gui_descri").val("");
    $("#gui_estado").val('ACTIVO');
...
function getModulos() {
    $.ajax({
        method: "POST",
        url: "/SysGym/referenciales/seguridad/GUI/listas/listaModulos.php",
        data: {
            mod_descri:$("#mod_descri").val()
        }
