    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de gui USUARIOS -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE USUARIOS<small>Registrar los datos de los usuarios</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="usu_cod" class="form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="password" id="usu_contrasena" class="form-control disabledno" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="usu_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de usuarios -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE USUARIOS <small>Listado de los usuarios</small>
                            </h2>
                        </div>
                        <div class="body">
