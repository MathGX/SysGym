        ...
        <div class="container-fluid">
            <div class="row clearfix">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="permi_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="permi_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="permi_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de permisos -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario permisos -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE PERMISOS <small>Permisos para usuarios</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover table-borderer table-stripeddataTable js-exportable">
                                    <thead>
                                        <tr>
                                            <th>CÓDIGO</th>
                                            <th>PERMISO</th>
