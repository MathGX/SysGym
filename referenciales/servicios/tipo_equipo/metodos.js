...
let getCod = () => {
    $.ajax({
        ...
        $("#tipequi_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tipequi_estado: $("#tipequi_estado").val(),
        ...
        url: "controlador.php"
            ...
            for (objeto of respuesta) {
                tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                    tabla += "<td>";
                        tabla += objeto.tipequi_cod;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipequi_descri;
                    tabla += "</td>";
                    tabla += "<td>";
                        tabla += objeto.tipequi_estado;
                    tabla += "</td>";
                tabla += "</tr>";
            }
