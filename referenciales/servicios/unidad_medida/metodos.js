...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            uni_estado: $("#uni_estado").val(),
            uni_simbolo: $("#uni_simbolo").val(),
    ...
    $.ajax({
        ...
        for (objeto of respuesta) {
            tabla += "<tr onclick='seleccionarFila(" + JSON.stringify(objeto).replace(/'/g, '&#39;') + ")'>";
                tabla += "<td>";
                    tabla += objeto.uni_cod;
                tabla += "</td>";
                tabla += "<td>";
                    tabla += objeto.uni_descri;
                tabla += "</td>";
                tabla += "<td>";
                    tabla += objeto.uni_simbolo;
                tabla += "</td>";
                tabla += "<td>";
                    tabla += objeto.uni_estado;
                tabla += "</td>";
            tabla += "</tr>";
        }
