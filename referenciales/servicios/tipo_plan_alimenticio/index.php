...
<head>
    ...
    <title>TIPO DE PLAN ALIMENTICIO</title>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de TIPO DE PLAN ALIMENTICIO -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE TIPOS DE PLAN ALIMENTICIO<small>Registro de tipos de planes alimenticios</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiplan_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiplan_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="tiplan_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario TIPO DE PLAN ALIMENTICIO -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE TIPOS DE PLAN ALIMENTICIO<small>Tipos de plan alimenticio recetados</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover table-borderer table-striped dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            <th>CÓDIGO</th>
                                            <th>TIPO DE PLAN ALIMENTICIO</th>
                                            <th>ESTADO</th>
                                        </tr>
                                    </thead>
