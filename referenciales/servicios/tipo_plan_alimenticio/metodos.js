...
let getCod = () => {
    $.ajax({
        ...
        $("#tiplan_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tiplan_estado: $("#tiplan_estado").val(),
...
let listar = () => {
    $.ajax({
        ...
        for (objeto of respuesta) {
            ...
            tabla += "<td>";
            tabla += objeto.tiplan_cod;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.tiplan_descri;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.tiplan_estado;
            tabla += "</td>";
            tabla += "</tr>";
        }
