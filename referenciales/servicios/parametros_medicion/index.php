...
<head>
    ...
    <title>PARÁMETROS DE MEDICIÓN</title>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de PARÁMETRO DE MEDICIÓN -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE PARÁMETROS DE MEDICIÓN<small>Registro de parametros de medición de clientes</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="param_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="param_formula" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="param_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario PARÁMETRO DE MEDICIÓN -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE PARÁMETROS DE MEDICIÓN<small>Parámetros utilizados para tomar medidas</small>
                            </h2>
                        </div>
                        <div class="body">
