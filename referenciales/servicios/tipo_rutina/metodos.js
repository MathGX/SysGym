...
let getCod = () => {
    $.ajax({
        ...
        $("#tiprut_cod").val(respuesta.codigo);
    });
}
...
let grabar = () => {
    $.ajax({
        ...
        data: {
            ...
            tiprut_estado: $("#tiprut_estado").val(),
...
let listar = () => {
    $.ajax({
        ...
        for (objeto of respuesta) {
            ...
            tabla += "<td>";
            tabla += objeto.tiprut_cod;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.tiprut_descri;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.tiprut_estado;
            tabla += "</td>";
            tabla += "</tr>";
        }
