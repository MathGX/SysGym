        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE EQUIPOS<small>Registrar datos de equipos</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="equi_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            ...
                                            <input type="text" class="form-control disabledno" id="tipequi_descri" disabled onkeyup="getTipoEquipos()">
                                            <label class="form-label">Tipo de Equipo</label>
                                            <div id="listaTipoEquipos" style="display: none;">
                                                <ul class="list-group" id="ulTipoEquipos" style="height:60px; overflow:auto;"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="equi_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="equi_estado" class="form-control" disabled>
                            ...
                            <!-- botones del formulario de equipos -->
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario equipos -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE EQUIPOS <small>Lista de equipos en existencia</small>
                            </h2>
                        </div>
                        <div class="body">
