...
let getCod = () => {
    $.ajax({
        ...
        $("#hrcom_cod").val(respuesta.codigo);
    });
}
...
let listar = () => {
    $.ajax({
        ...
        for (objeto of respuesta) {
            ...
            tabla += "<td>";
            tabla += objeto.hrcom_cod;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.hrcom_descri;
            tabla += "</td>";
            tabla += "<td>";
            tabla += objeto.hrcom_estado;
            tabla += "</td>";
            tabla += "</tr>";
        }
