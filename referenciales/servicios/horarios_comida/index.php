...
<head>
    ...
    <title>HORARIOS DE COMIDA</title>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <!-- formulario de HORARIOS DE COMIDA -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                FORMULARIO DE HORARIOS DE COMIDA<small>Registro de horarios de comida</small>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="hrcom_cod" class="form-control" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="hrcom_descri" class="form-control disabledno" disabled>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        <div class="form-line focus">
                                            <input type="text" id="hrcom_estado" class="form-control" disabled>
                ...
                <div class="col-lg-12 tbl" style="display: block;">
                    <!-- grilla del formulario HORARIOS DE COMIDA -->
                    <div class="card">
                        <div class="header bg-indigo">
                            <h2>
                                LISTADO DE HORARIOS DE COMIDA<small>Horarios en los que se deben consumir los alimentos</small>
                            </h2>
                        </div>
                        <div class="body">
